...
- **Where it is heading** — architectural trajectory and detailed design chapters (calculated fields, provenance, store topology, sidecars), clearly separated from production guarantees ([Architectural trajectory](trajectory.md)).
